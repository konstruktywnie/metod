...
enum ProgEventNames { EVENT_TILESET_ANIMATION = 0, EVENT_TILESET_COLLIDED, EVENT_TILESET_COLLIDED_FULL, EVENT_WINDOW_SCROLL, EVENT_TILESET_ANIMATION_ENDED_LOOP, EVENT_TILESET_ENDED_MOVCOUNTER, MAX_ProgEventNames };
