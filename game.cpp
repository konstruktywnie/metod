...
/*
  ...
  */
  ...
  //Game.res->tileSequences[ 0 ].actualVO->win = Game.screens[ SCREEN_GAME ].windows[ WINDOW_LEVEL ];
  ...
  //Game.res->tileSequences[ 1 ].actualVO->win = Game.screens[ SCREEN_GAME ].windows[ WINDOW_LEVEL ];
